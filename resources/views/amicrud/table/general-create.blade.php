                  ...
                  <div class="col-md-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title mb-0">Add, Edit &amp; Remove {{form_labels($model_name)}}</h4>
                            </div><!-- end card header -->
                                ...
                                <div id="customerList">
                                    ...
                                    <div class="row g-4 mb-3">
                                        <div class="col-sm-auto">
                                            <div>
                                                <button type="button" class="btn btn-success add-btn" data-bs-toggle="modal" id="create-btn" data-bs-target="#showModal" data-name="{{Str::singular($model_name)}}" data-url="{{sign_url(route($form_edit_route,'null'))}}"><i class="ri-add-line align-bottom me-1"></i> Add</button>
                                                 <!-- Vertical Variation -->
